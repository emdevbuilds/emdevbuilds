...
[![Email](https://img.shields.io/badge/Email-emmanuel.devpro%40gmail.com-EA4335?style=for-the-badge&logo=gmail)](mailto:emmanuel.devpro@gmail.com)
[![Twitter](https://img.shields.io/badge/Twitter-emdevbuilds-1DA1F2?style=for-the-badge&logo=twitter)](https://x.com/emdevbuilds)
...
### [Zewerk](https://github.com/emdevbuilds)
> Blue-collar worker marketplace for Nigeria

Full-stack platform connecting clients with skilled workers. Features real-time messaging, Paystack escrow payments, OTP verification via Termii SMS, and Cloudinary media uploads.

`Next.js` `Express` `TypeScript` `PostgreSQL` `Prisma` `Redis` `Socket.io` `Docker` `Paystack`
